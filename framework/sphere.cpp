...
//Sphere
Sphere::Sphere():center{glm::vec3()},radius{0},m_color{Color()},m_name{"no_name"}{
	//std::cout << "Constructor - Sphere\n";
}
Sphere::Sphere( glm::vec3 const&ctr, float const&r):Shape{"no_name",Color()},center{ctr},radius{r}{
	//std::cout << "Constructor - Sphere\n";
}
Sphere::Sphere( glm::vec3 const&ctr, float const&r, Color const&clr, std::string const&name):Shape{name,clr},center{ctr},radius{r}{
//	std::cout << "Constructor - Sphere\n";
}
